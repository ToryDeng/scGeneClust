...
def inter_cluster_score(adata: ad.AnnData, inter_score: Literal['top3', 'silhouette']):
    ...
    q = adata.var.drop_duplicates('cluster_label')['cluster_score'].quantile(q=0.1)
    adata.var['use_cluster'] = adata.var['cluster_score'] >= q
